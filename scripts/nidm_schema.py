...
class OwlNidmHtml:
    def __init__(self, term_infos, import_files, spec_name, schema_file=None):
        ...
        for terms in term_infos:
            ...
            self.schema_text = "<div class=\"container-fluid\"><section id=\"viewer\"><h2>NIDM Class Browser</h2><div class=\"row\"><div class=\"col-5\"><div id='schema' class='list-group list-group-root well'>"
            self.schema_done = []
...
def create_schema_file(schema_file="schema_class.html"):
    if schema_file == "schema_class.html":
        schema_file = os.path.join(DOC_FOLDER, "schema_class.html")
...
def schema_footer(schema_file="schema_class.html"):
    if schema_file == "schema_class.html":
        schema_file = os.path.join(DOC_FOLDER, "schema_class.html")
    schema_open = codecs.open(schema_file, 'a', "utf-8")
    schema_open.write("""
...
def main():
    ...
    schema_footer(schema_file="schema_class.html")
